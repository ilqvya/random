...
[![Build status](https://ci.appveyor.com/api/projects/status/vq1kodqqxwx16rfv/branch/MoveTravisCItoAppVeyor?svg=true)](https://ci.appveyor.com/project/effolkronium/random/branch/master)
